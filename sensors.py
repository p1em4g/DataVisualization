sensors = [
    ['1', '1. Temperature (bmp180_temp)'],
    ['2', '2. Pressure (bmp180_pressure)'],
    ['3', '3. CO2 (raw_co2)', 'value'],
    ['4','4. Humidity (si7021_hum)'],
    ['5','5. Temperature (si7021_temp)'],
    ['6','6. Mass (scales_data)'],
    ['7','7. ds18b20_ab3b (ds18b20_ab3b)'],
